  ...
  return (
    <aside className="sticky top-0 hidden h-dvh w-[260px] shrink-0 flex-col border-l border-white/10 bg-white/[0.03] backdrop-blur-2xl lg:flex">
      ...
      <div className="flex items-center gap-2.5 px-6 py-6">
        <div className="flex size-10 items-center justify-center rounded-2xl bg-gradient-to-br from-brand to-cyan-500 text-white shadow-lg shadow-brand/30">
          <Sparkles className="size-5" />
        </div>
        <div>
          <p className="font-extrabold leading-none text-gradient-brand">SpeakUp</p>
